...
if (isset($_POST['submit'])) {
    ...
    $products->insertProduct($product_name, $product_category, $product_description,"");
    print_r($_POST);
}
...
<div class="container">
<h1 class="mt-5">Add a product</h1>
<form method="post" enctype="multipart/form">
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Product Name</label>
    <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Specify Product Name..">
  </div>

  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Product Category</label>
    <input type="text" class="form-control" id="product_category" name="product_category" placeholder="Specify Product Category..">
  </div>
  <div class="mb-3"">
    <label for="floatingTextarea2">Product Description</label>
    <textarea class="form-control"  id="product_description" name="product_description" placeholder="Specify Product Description..." style="height: 100px"></textarea>
</div>
